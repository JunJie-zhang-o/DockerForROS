...
RUN apt install bash-completion openssh-server net-tools nano zsh git curl x11-apps iputils-ping sshpass fakeroot python3-bloom debhelper unzip zip tree python3-pip -y 
